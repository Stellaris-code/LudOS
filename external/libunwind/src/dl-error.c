  ...
  if (lcatch != NULL)
    {
      ...
      lcatch->errstring = (char *) kmalloc (len_objname + len_errstring);
      if (lcatch->errstring != NULL)
        {
          /* Make a copy of the object file name and the error string.  */
          lcatch->objname = memcpy (memcpy ((char *) lcatch->errstring,
      ...
      __builtin_setjmp ((void*)&lcatch->env[0]);
    }
  else
    {
      ...
      _dl_fatal_printf ("%s: %s: %s%s%s%s%s\n",
                        ...
                        errstring, errcode ? ": " : "",
                        (errcode
                         ? _strerror_r(errcode, buffer, sizeof buffer)
                         : ""));
    }
}
                 ...
                 bool *mallocedp, void (*operate) (void *), void *args)
{
  ...
  errcode = __builtin_setjmp (c.env);
